...
const DEPARTMENTS = [
  ...
  'Nursing Science', 'Student Affairs', 'Administration',
];

export default function EditOrganizerProfileScreen({ navigation }) {
  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.content} keyboardShouldPersistTaps="handled">
      <View style={styles.headerSection}>
        ...
        <Text style={styles.headerName}>{displayName || 'Organizer'}</Text>
      </View>
...
const styles = StyleSheet.create({
  ...
  headerSection: { backgroundColor: '#1b5e20', alignItems: 'center', paddingVertical: 28 },
  avatarBox: { width: 80, height: 80, borderRadius: 40, backgroundColor: '#fff', justifyContent: 'center', alignItems: 'center', marginBottom: 10 },
  avatarInitial: { fontSize: 32, fontWeight: '900', color: '#1b5e20' },
  ...
  deptItemActive: { backgroundColor: '#e8f5e9' },
  deptItemText: { fontSize: 14, color: '#444' },
  deptItemTextActive: { color: '#1b5e20', fontWeight: '700' },
  saveBtn: { backgroundColor: '#1b5e20', borderRadius: 14, padding: 16, alignItems: 'center', marginTop: 28, elevation: 3 },
